...
//        msystem.postDelayScript(this, mDelays[current_step]);
    ...
    protected int getcurrest_step_delay() {
            return mDelays[current_step];
    }

    protected boolean hasNext() {
        return current_step < command_length;
    }

    protected String handleNext() {
        String[] temp = seperateCommand(mCommands[current_step]);
        current_step++;
        String toSDKCommand;
