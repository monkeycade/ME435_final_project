package edu.rose_hulman.jins.fsm_main;
...
public class FSM_System extends MainCommandBin {
...
//        mScripts.farBallScript();
  ...
  private void handleBallClickForLocation(final int location) {
    AlertDialog.Builder builder = new AlertDialog.Builder(FSM_System.this);
    builder.setTitle("What was the real color?").setItems(R.array.ball_colors,
        new DialogInterface.OnClickListener() {
          public void onClick(DialogInterface dialog, int which) {
            FSM_System.this.setLocationToColor(location, BallColor.values()[which]);
          }
        });
    builder.create().show();
  }
...
//    sendCommand("CUSTOM balltest");
  ...
  public void handleDrivingStraight(View view) {
    system_print("handleDrivingStraight");
    AlertDialog.Builder builder = new AlertDialog.Builder(FSM_System.this);
